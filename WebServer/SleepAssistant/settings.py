...
ALLOWED_HOSTS = ['.sleep-assistant.com', '.sleep-assistant.com.', 'dry-falls-7363.herokuapp.com', '127.0.0.1', 'localhost']
...
WSGI_APPLICATION = 'SleepAssistant.wsgi.application'
...
ACCOUNT_LOGIN_REDIRECT_URL = reverse('summary')
